...
void ModemManager::onStateChanged(const State &state)
{
  ...
  if (_ofonoManager == sender_ptr)
  {
    ...
    {
      case State::Signal: _signalOfonoManager(state); break;
      default: D(state); break;
    }
  }
  else if (_manager == sender_ptr)
  {
    switch (state._status)
    {
      case State::Signal: _signalManager(state); break;
      default: D(state); break;
    }
  }
  else if (_modem == sender_ptr)
  {
    switch (state._status)
    {
      case State::Signal: _signalModem(state); break;
      case State::CallStarted: break;
      case State::CallFinished: break;
      case State::CallError: break;
      default: D(state); break;
    }
  }
  else if (_simManager == sender_ptr)
  {
    switch (state._status)
    {
      case State::Signal: _signalSimManager(state); break;
      case State::CallStarted: break;
      case State::CallFinished: break;
      case State::CallError: break;
      default: D(state); break;
  ...
  else if (_networkRegistration == sender_ptr)
  {
    switch (state._status)
    {
      case State::Signal: _signalNetworkRegistration(state); break;
      case State::CallStarted: break;
      case State::CallFinished: break;
      case State::CallError: break;
      default: D(state); break;
  ...
  else if (_connectionManager == sender_ptr)
  {
    switch (state._status)
    {
      case State::Signal: _signalConnectionManager(state); break;
      case State::CallStarted: break;
      case State::CallFinished: break;
      case State::CallError: break;
      default: D(state); break;
  ...
  else if (_connectionContext == sender_ptr)
  {
    switch (state._status)
    {
      case State::Signal: _signalConnectionContext(state); break;
      case State::CallStarted: break;
      case State::CallFinished: break;
      case State::CallError: break;
      default: D(state); break;
